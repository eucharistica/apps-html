						...
						<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex align-items-stretch">
							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">Subscription Details</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<td class="text-gray-800">**** 1477</td>
																				</tr>
																				<tr>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 4490</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 8839</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
