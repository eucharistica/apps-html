							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-2">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-600 fw-bold lh-1">Sales</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">Orders Listing</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
								...
								<div class="d-flex justify-content-between flex-wrap gap-4 gap-lg-10">
									...
									<div class="app-toolbar-menu menu menu-title-gray-800 menu-state-primary flex-wrap fs-5 fw-semibold w-100">
										<!--begin::Menu item-->
										<div class="menu-item">
											<a class="menu-link py-4 active" href="index.html">
										...
										<!--begin::Menu item-->
										<div class="menu-item">
											<a class="menu-link py-4" href="apps/projects/list.html">
												<span class="menu-title">Projects</span>
											</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item">
											<a class="menu-link py-4" href="apps/subscriptions/list.html">
												<span class="menu-title">Subscriptions</span>
											</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item">
											<a class="menu-link py-4" href="apps/file-manager/folders.html">
												<span class="menu-title">Files</span>
											</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item">
											<a class="menu-link py-4" href="apps/support-center/contact.html">
										...
										<!--begin::Menu item-->
										<div class="menu-item">
											<a class="menu-link py-4" href="apps/customers/list.html">
												<span class="menu-title">Customers</span>
											</a>
										</div>
										<!--end::Menu item-->
												...
												<tbody class="fw-semibold text-gray-600">
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13375</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-09-05">
															<span class="fw-bold">05/09/2025</span>
														</td>
														<td class="text-end" data-order="2025-09-09">
															<span class="fw-bold">09/09/2025</span>
														</td>
														<td class="text-end">
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13376</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-09-08">
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13377</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-09-07">
															<span class="fw-bold">07/09/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13378</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-09-04">
															<span class="fw-bold">04/09/2025</span>
														</td>
														<td class="text-end" data-order="2025-09-06">
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13379</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-30">
															<span class="fw-bold">30/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-09-05">
															<span class="fw-bold">05/09/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13380</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-09-01">
															<span class="fw-bold">01/09/2025</span>
														</td>
														<td class="text-end" data-order="2025-09-04">
															<span class="fw-bold">04/09/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13381</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$54.00</span>
														</td>
														<td class="text-end" data-order="2025-08-27">
															<span class="fw-bold">27/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-09-03">
															<span class="fw-bold">03/09/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13382</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-09-02">
															<span class="fw-bold">02/09/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13383</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-26">
															<span class="fw-bold">26/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-09-01">
															<span class="fw-bold">01/09/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13384</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-31">
															<span class="fw-bold">31/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13385</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-28">
															<span class="fw-bold">28/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-30">
															<span class="fw-bold">30/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13386</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-23">
															<span class="fw-bold">23/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-29">
															<span class="fw-bold">29/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13387</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13388</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-25">
															<span class="fw-bold">25/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-27">
															<span class="fw-bold">27/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13389</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-19">
															<span class="fw-bold">19/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-26">
															<span class="fw-bold">26/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13390</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-22">
															<span class="fw-bold">22/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-25">
															<span class="fw-bold">25/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13391</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-24">
															<span class="fw-bold">24/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13392</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-17">
															<span class="fw-bold">17/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-23">
															<span class="fw-bold">23/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13393</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-18">
															<span class="fw-bold">18/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-22">
															<span class="fw-bold">22/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13394</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-21">
															<span class="fw-bold">21/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13395</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-16">
															<span class="fw-bold">16/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-20">
															<span class="fw-bold">20/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13396</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13397</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-13">
															<span class="fw-bold">13/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-18">
															<span class="fw-bold">18/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13398</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-14">
															<span class="fw-bold">14/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-17">
															<span class="fw-bold">17/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13399</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-09">
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13400</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-10">
															<span class="fw-bold">10/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-15">
															<span class="fw-bold">15/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13401</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-08">
															<span class="fw-bold">08/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-14">
															<span class="fw-bold">14/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13402</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-12">
															<span class="fw-bold">12/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-13">
															<span class="fw-bold">13/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13403</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-11">
															<span class="fw-bold">11/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-12">
															<span class="fw-bold">12/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13404</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-07">
															<span class="fw-bold">07/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-11">
															<span class="fw-bold">11/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13405</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13406</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-02">
															<span class="fw-bold">02/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-09">
															<span class="fw-bold">09/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13407</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13408</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-03">
															<span class="fw-bold">03/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-07">
															<span class="fw-bold">07/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13409</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-06">
															<span class="fw-bold">06/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13410</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-29">
															<span class="fw-bold">29/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-05">
															<span class="fw-bold">05/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13411</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-28">
															<span class="fw-bold">28/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-04">
															<span class="fw-bold">04/08/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13412</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13413</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-08-01">
															<span class="fw-bold">01/08/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-02">
															<span class="fw-bold">02/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13414</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-25">
															<span class="fw-bold">25/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-08-01">
															<span class="fw-bold">01/08/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13415</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-24">
															<span class="fw-bold">24/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-07-31">
															<span class="fw-bold">31/07/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13416</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-23">
															<span class="fw-bold">23/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-07-30">
															<span class="fw-bold">30/07/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13417</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-22">
															<span class="fw-bold">22/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-07-29">
															<span class="fw-bold">29/07/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13418</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-27">
															<span class="fw-bold">27/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-07-28">
															<span class="fw-bold">28/07/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13419</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13420</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-26">
															<span class="fw-bold">26/07/2025</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-outline ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13421</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-21">
															<span class="fw-bold">21/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-07-25">
															<span class="fw-bold">25/07/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13422</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13423</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-18">
															<span class="fw-bold">18/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-07-23">
															<span class="fw-bold">23/07/2025</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13424</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2025-07-16">
															<span class="fw-bold">16/07/2025</span>
														</td>
														<td class="text-end" data-order="2025-07-22">
															<span class="fw-bold">22/07/2025</span>
														</td>
