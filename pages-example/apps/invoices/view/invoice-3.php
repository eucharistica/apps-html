...
<base href="../../../" />
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="print-content-only app-default">
							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-2">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-600 fw-bold lh-1">Invoice Manager</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-600 fw-bold lh-1">View Invoices</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">Invoice 3</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
											...
											<div class="mw-lg-950px mx-auto w-100">
												...
												<div class="pb-12">
													...
													<div class="d-flex flex-column gap-7 gap-md-10">
														<!--begin::Message-->
														<div class="fw-bold fs-2">Dear Neil Owen 
														...
														<div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
															...
															<div class="flex-root d-flex flex-column">
																...
																<span class="fs-5">10 September, 2025</span>
															</div>
															<div class="flex-root d-flex flex-column">
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="ms-5">
																						...
																						<div class="fs-7 text-muted">Delivery Date: 10/09/2025</div>
																					</div>
																					<!--end::Title-->
																				</div>
																			</td>
																			<td class="text-end">02859009</td>
