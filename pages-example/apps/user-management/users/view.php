							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-2">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-600 fw-bold lh-1">User Management</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-600 fw-bold lh-1">Users</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">View User Details</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
												...
												<div class="card-body">
													...
													<div id="kt_user_view_details" class="collapse show">
														<div class="pb-5 fs-6">
															...
															<div class="text-gray-600">15 Apr 2025, 11:30 am</div>
															<!--begin::Details item-->
														</div>
													</div>
													<!--end::Details content-->
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
																	<tbody>
																		<tr>
																			...
																			<td>POST /v1/invoice/in_3913_9847/invalid</td>
																			<td class="pe-0 text-end min-w-200px">24 Jun 2025, 8:43 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			</td>
																			<td>POST /v1/invoice/in_4974_1554/invalid</td>
																			<td class="pe-0 text-end min-w-200px">19 Aug 2025, 5:20 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-warning">404 WRN</div>
																			</td>
																			<td>POST /v1/customer/c_68c1185b153ae/not_found</td>
																			<td class="pe-0 text-end min-w-200px">05 May 2025, 10:10 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																			</td>
																			<td>POST /v1/invoices/in_8446_1828/payment</td>
																			<td class="pe-0 text-end min-w-200px">10 Nov 2025, 6:05 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			</td>
																			<td>POST /v1/invoice/in_4167_4219/invalid</td>
																			<td class="pe-0 text-end min-w-200px">25 Jul 2025, 8:43 pm</td>
																		</tr>
																	</tbody>
																</table>
																<!--end::Table-->
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																<tbody>
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2025, 6:43 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2025, 6:43 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#DER-45645</a>status has changed from 
																		<span class="badge badge-light-info me-1">In Progress</span>to 
																		<span class="badge badge-light-primary">In Transit</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2025, 5:20 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2025, 10:10 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#LOP-45640</a>has been 
																		<span class="badge badge-light-danger">Declined</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2025, 5:30 pm</td>
																	</tr>
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2025, 6:05 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Melody Macy</a>has made payment to 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2025, 10:10 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#DER-45645</a>status has changed from 
																	...
																	<tr>
																		...
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#LOP-45640</a>has been 
																		<span class="badge badge-light-danger">Declined</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2025, 10:10 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#LOP-45640</a>has been 
																		<span class="badge badge-light-danger">Declined</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2025, 5:30 pm</td>
																	</tr>
																</tbody>
															</table>
															<!--end::Table-->
