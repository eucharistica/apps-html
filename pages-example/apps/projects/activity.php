						...
						<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex align-items-stretch">
							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">Project Activity</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
										...
										<div class="card-header card-header-stretch">
											...
											<div class="card-toolbar m-0">
												...
												<ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bold" role="tablist">
													...
													<li class="nav-item" role="presentation">
														<a id="kt_activity_year_tab" class="nav-link justify-content-center text-active-gray-800 text-hover-gray-800" data-bs-toggle="tab" role="tab" href="#kt_activity_year">2025</a>
													</li>
												</ul>
												<!--end::Tab nav-->
											</div>
