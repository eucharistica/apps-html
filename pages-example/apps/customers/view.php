							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-2">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-600 fw-bold lh-1">Customers</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">Customer Details</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
														...
														<div class="card-body pt-0 pb-5">
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">4849-1806</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">4311-8133</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">6901-4251</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">7815-1903</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">9664-5252</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">4443-3255</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">1789-8520</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">1220-8074</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">9123-5053</a>
																		</td>
																		<td>
																			<span class="badge badge-light-warning">Pending</span>
																		</td>
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<td class="text-gray-800">**** 3788</td>
																				</tr>
																				<tr>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 6402</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 5182</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
																	<tbody>
																		<tr>
																			...
																			<td>POST /v1/customer/c_68c118645a9fe/not_found</td>
																			<td class="pe-0 text-end min-w-200px">21 Feb 2025, 11:05 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-warning">404 WRN</div>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_2968_7128/payment</td>
																			<td class="pe-0 text-end min-w-200px">24 Jun 2025, 5:30 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-warning">404 WRN</div>
																			</td>
																			<td>POST /v1/customer/c_68c118645a9ff/not_found</td>
																			<td class="pe-0 text-end min-w-200px">10 Nov 2025, 5:30 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-warning">404 WRN</div>
																			...
																			<td>POST /v1/customer/c_68c118645a9fe/not_found</td>
																			<td class="pe-0 text-end min-w-200px">05 May 2025, 11:05 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			</td>
																			<td>POST /v1/invoice/in_7780_5682/invalid</td>
																			<td class="pe-0 text-end min-w-200px">20 Dec 2025, 10:10 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																			</td>
																			<td>POST /v1/invoices/in_2367_2569/payment</td>
																			<td class="pe-0 text-end min-w-200px">05 May 2025, 11:30 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																			</td>
																			<td>POST /v1/invoices/in_8160_5954/payment</td>
																			<td class="pe-0 text-end min-w-200px">05 May 2025, 9:23 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			...
																			<td>POST /v1/invoice/in_7780_5682/invalid</td>
																			<td class="pe-0 text-end min-w-200px">20 Dec 2025, 5:30 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			</td>
																			<td>POST /v1/invoice/in_8312_6107/invalid</td>
																			<td class="pe-0 text-end min-w-200px">15 Apr 2025, 11:05 am</td>
																		</tr>
																	</tbody>
																</table>
															</div>
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																<tbody>
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2025, 5:30 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#KIO-45656</a>status has changed from 
																		<span class="badge badge-light-succees me-1">In Transit</span>to 
																		<span class="badge badge-light-success">Approved</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2025, 8:43 pm</td>
																	</tr>
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2025, 6:43 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2025, 2:40 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2025, 10:10 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2025, 11:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2025, 10:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Brian Cox</a>has made payment to 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary">#OLP-45690</a></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2025, 6:05 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#WER-45670</a>is 
																		<span class="badge badge-light-info">In Progress</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">10 Nov 2025, 6:05 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#KIO-45656</a>status has changed from 
																		<span class="badge badge-light-succees me-1">In Transit</span>to 
																		<span class="badge badge-light-success">Approved</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2025, 11:05 am</td>
																	</tr>
																</tbody>
															</table>
															<!--end::Table-->
