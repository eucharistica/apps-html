...
<base href="../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comdashboards/delivery.html" />
												...
												<div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible" data-kt-menu-dismiss="true">
													...
													<div class="row">
														...
														<div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="dashboards/delivery.html" class="menu-link py-2 active">
						...
						<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex align-items-stretch">
							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">Delivery</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
