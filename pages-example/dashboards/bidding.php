...
<base href="../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comdashboards/bidding.html" />
														...
														<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
															...
															<div class="row">
																...
																<div class="col-lg-6 mb-3">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="dashboards/bidding.html" class="menu-link active">
																			<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
						...
						<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex align-items-stretch">
							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">Bidding Dashboard</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
