						...
						<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex align-items-stretch">
							...
							<div class="app-toolbar-container d-flex flex-column flex-row-fluid">
								...
								<div class="page-title gap-4 me-3 mb-3 mb-lg-5">
									...
									<!--end::Breadcrumb-->
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder m-0">Charts</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
											...
											<div class="card card-xl-stretch mb-xl-8">
												...
												<div class="card-header border-0 pt-5">
													...
													<div class="card-toolbar">
														...
														<!--begin::Menu 1-->
														<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_68c1184b4f75e">
															<!--begin::Header-->
															<div class="px-7 py-5">
															...
															<div class="px-7 py-5">
																...
																<div class="mb-10">
																	...
																	<!--begin::Input-->
																	<div>
																		<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_68c1184b4f75e" data-allow-clear="true">
																			<option></option>
